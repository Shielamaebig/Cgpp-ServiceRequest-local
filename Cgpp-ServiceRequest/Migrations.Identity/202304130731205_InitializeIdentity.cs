    ...
    public partial class InitializeIdentity : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        DateAdded = c.String(),
                        State = c.String(),
                        HardwareUserRequestId = c.Int(nullable: true),
                        TechnicianReportId = c.Int(),
                        HardwareVerifyId = c.Int(),
                ...
                c => new
                    {
                        Id = c.Int(nullable: true, identity: false),
                        DateAdded = c.String(),
                        SoftwareUserRequestId = c.Int(nullable: true),
                        FullName = c.String(),
                        Email = c.String(),
                        DepartmentsId = c.Int(nullable: false),
                        DepartmentName = c.String(),
                        DivisionsId = c.Int(nullable: true),
                        DivisionName = c.String(),
                        IsAccept = c.String(),
                    })
                .PrimaryKey(t => t.Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        MobileNumber = c.String(),
                        Email = c.String(),
                        DepartmentsId = c.Int(nullable: true),
                        DepartmentName = c.String(),
                        DivisionsId = c.Int(nullable: true),
                        DivisionName = c.String(),
                        Status = c.String(),
                ...
                .ForeignKey("dbo.Divisions", t => t.DivisionsId, cascadeDelete: false)
                .ForeignKey("dbo.InformationSystems", t => t.InformationSystemId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.SoftwareTasks", t => t.SoftwareTaskId, cascadeDelete: true)
                .ForeignKey("dbo.SoftwareUserRequests", t => t.SoftwareUserRequestId)
                .ForeignKey("dbo.SoftwareVerifications", t => t.SoftwareVerificationId)
                .Index(t => t.SoftwareTaskId)
                .Index(t => t.SoftwareUserRequestId)
                .Index(t => t.SoftwareAcceptsRequestId)
                .Index(t => t.ProgrammerReportId)
                .Index(t => t.SoftwareVerificationId)
