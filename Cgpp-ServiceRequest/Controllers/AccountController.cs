...
namespace Cgpp_ServiceRequest.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Authorize]
        [Route("ChangePassword/v2/{id}")]
        public async Task<IHttpActionResult> ChangePassword2(string id, ChangePasswordBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            //{
            //    Sendto = User.Identity.GetUserMobileNumber(),
            //    msg ="Cgpp Service Desk" + " " + " User Name: " + " " + User.Identity.GetUserName() + " " + " New Password:"+ " " + model.NewPassword,
            //    tag = 0
            //});
            //Db.SaveChanges();
        ...
        public async Task<IHttpActionResult> ChangePassword(string id, ChangePasswordBindingModel model)
        {
            ...
            user2.MobileNumber = model.MobileNumber;
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser()
            {
                ...
                DepartmentName = db.Departments.SingleOrDefault(x => x.Id == model.DepartmentsId).Name,
                DivisionName = db.Divisions.SingleOrDefault(x => x.Id == model.DivisionsId).Name,
        ...
        public async Task<IHttpActionResult> UpdateName(string id, [FromBody] ChangeNameBindingModel model)
        {
            ...
            user.DepartmentName = db.Departments.SingleOrDefault(x => x.Id == model.DepartmentsId).Name;
            user.DivisionName = db.Divisions.SingleOrDefault(x => x.Id == model.DivisionsId).Name;
        ...
        //user 
        [Route("UserApproval/{id}")]
        public async Task<IHttpActionResult> UserApproval(string id, [FromBody] UserApprovalBindngModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Route("UserDeactive/{id}")]
        public async Task<IHttpActionResult> UserDeactive(string id, [FromBody] UserApprovalBindngModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
